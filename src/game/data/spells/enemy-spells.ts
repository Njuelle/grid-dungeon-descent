...
export const SHAMAN_ENEMY_SPELLS: SpellDefinition[] = [
    ...
    },
    {
        id: "enemy_hex_curse",
        name: "Hex Curse",
        icon: "icon_enemy_hex_curse",
        apCost: 2,
        range: 3,
        minRange: 1,
        damage: 1,
        description: "Curses the target with poison for 2 turns",
        type: "magic",
        statusEffect: {
            type: "poison",
            duration: 2,
...
export const BERSERKER_ENEMY_SPELLS: SpellDefinition[] = [
    ...
    },
    {
        ...
        name: "Stunning Blow",
        icon: "icon_enemy_stunning_blow",
        apCost: 2,
        range: 1,
        damage: 3,
        description: "A powerful blow that stuns the target for 1 turn",
        type: "melee",
        statusEffect: {
            type: "stun",
            duration: 1,
...
export const FROST_MAGE_ENEMY_SPELLS: SpellDefinition[] = [
    ...
    {
        id: "enemy_flash_freeze",
        name: "Flash Freeze",
        icon: "icon_enemy_flash_freeze",
        apCost: 2,
        range: 3,
        minRange: 1,
        damage: 2,
        description: "Freezes the target in place, rooting them for 2 turns",
        type: "magic",
        statusEffect: {
            type: "root",
            duration: 2,
...
export const DARK_KNIGHT_ENEMY_SPELLS: SpellDefinition[] = [
    ...
    {
        id: "enemy_dread_strike",
        name: "Dread Strike",
        icon: "icon_enemy_dread_strike",
        apCost: 2,
        range: 1,
        damage: 2,
        description: "Strikes fear into the target, making them vulnerable for 2 turns",
        type: "melee",
        statusEffect: {
            type: "vulnerable",
            duration: 2,
            value: 1.5, // 50% more damage taken
        },
        animation: "vfx_melee_attack",
    },
];
