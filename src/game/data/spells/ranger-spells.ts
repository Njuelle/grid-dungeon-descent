...
export const RANGER_STARTING_SPELLS: SpellDefinition[] = [
    ...
    },
    {
        ...
        minRange: 1,
        damage: 0,
        description: "Mark an enemy, making them vulnerable (+30% damage taken) for 3 turns",
        type: "ranged",
        spellCategory: "buff",
        statusEffect: {
            type: "vulnerable",
...
export const RANGER_ARTIFACT_SPELLS: SpellDefinition[] = [
    ...
    },
    {
        ...
        range: 5,
        damage: 0,
        description: "Mark target, making them vulnerable (+50% damage taken) for 2 turns",
        type: "ranged",
        spellCategory: "buff",
        statusEffect: {
            type: "vulnerable",
    ...
    },
    {
        ...
        minRange: 1,
        damage: 0,
        description: "Mark an enemy, making them vulnerable (+60% damage taken) for 2 turns",
        type: "ranged",
        spellCategory: "buff",
        statusEffect: {
            type: "vulnerable",
    ...
    },
    {
        ...
        minRange: 1,
        damage: 0,
        description: "Analyze enemy, making them vulnerable (+75% damage taken) for 1 turn",
        type: "ranged",
        spellCategory: "buff",
        statusEffect: {
            type: "vulnerable",
