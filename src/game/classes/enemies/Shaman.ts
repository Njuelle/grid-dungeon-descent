...
export class Shaman extends Enemy {
    constructor(scene: Scene, gridX: number, gridY: number) {
        const stats: UnitStats = {
            ...
            force: 0,
            dexterity: 1, // Weak attack
            intelligence: 2, // Magic focus
            armor: 0,
            actionPoints: 3, // Extra AP for support
            maxActionPoints: 3,
            movementPoints: 2,
            maxMovementPoints: 2,
        };

        super(scene, gridX, gridY, stats, "Shaman");
    }

    protected createSprite(): void {
        // Use the shaman sprite
        this.sprite = this.scene.add.sprite(0, 0, "shaman_idle");
    ...
    protected getColor(): number {
        return 0x228b22; // Forest green for shaman
    }
